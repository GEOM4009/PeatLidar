...
project = 'PeatLidar'
copyright = '2026, Vincent Ribberink, Joshua Salvador, Ethan Gauthier'
author = 'Vincent Ribberink, Joshua Salvador, Ethan Gauthier'
release = '1.0.0'
...
# both rst and md files can be used here...
